...
public class ExpenseWarning extends DialogFragment {
    private String body;
    ExpenseWarningListener listener;
    int currentLayout;
    String positiveButtonText = "YES";
    String negativeButtonText = "NO";

    public interface ExpenseWarningListener {
        ...
        builder.setView(inflater.inflate(currentLayout, null))
                .setPositiveButton(positiveButtonText, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        listener.onDialogPositiveClick(ExpenseWarning.this);
                    }
                })
                .setNegativeButton(negativeButtonText, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        listener.onDialogNegativeClick(ExpenseWarning.this);
                    }
                });
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (ExpenseWarningListener) context;
        } catch (Exception e) {
