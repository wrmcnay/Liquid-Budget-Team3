...
public class ViewCategoryIncomeAdapter extends RecyclerView.Adapter<ViewCategoryIncomeAdapter.IncomeHolder> {
...
//    private static ClickListener clickListener;
    ...
    public IncomeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.category_incomes, parent, false);
