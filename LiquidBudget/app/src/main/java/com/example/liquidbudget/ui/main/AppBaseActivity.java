...
public abstract class AppBaseActivity extends AppNavigationActivity implements MenuItem.OnMenuItemClickListener {
...
//                Intent homeIntent = new Intent(this, SpendingSavingPage.class);
            ...
            case R.id.nav_incomes:
                ...
                break;*/
            case R.id.nav_extEd:
                Intent extEdIntent = new Intent(this, ExtendedEducationActivity.class);
                startActivity(extEdIntent);
                if(!(this instanceof MainActivity))
                    finish();
                break;
